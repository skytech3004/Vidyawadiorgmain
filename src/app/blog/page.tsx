...
export const metadata = {
    title: "Blog | Vidyawadi",
    description: "Insights, stories, and updates from the vibrant life at Vidyawadi.",
};
        ...
        <main className="min-h-screen bg-white">
            ...
            <section id="home" data-theme="light" className="pt-32 pb-16 px-6 bg-slate-50 border-b border-black/5 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <h1 className="text-5xl md:text-7xl mb-6 text-oxford">
                        Our Blog
                    </h1>
                ...
                <div className="max-w-5xl mx-auto">
                    {posts.length === 0 ? (
                        <div className="text-center py-20">
                            ...
                            <p className="text-gray-500 font-medium">No published posts yet. Check back soon.</p>
                        </div>
                    ) : (
