                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        <div className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-sandstone overflow-hidden bg-white shrink-0">
                            <img src="/leeladevi.jpg" alt="Leeladevi College Logo" className="w-full h-full object-cover" />
                        </div>
                        <div>
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="prose text-gray-600 leading-relaxed space-y-4">
                            <p>
                                Leeladevi Parasmal Sancheti Kanya Mahavidyalaya is a women-only higher education institution managed by <b>Marudhar Mahila Shikshan Sangh, Vidyawadi</b>.
                        ...
                        >
                            ...
                            <div className="p-8 md:p-12 border-t border-gray-100 bg-gray-50 flex justify-between items-center shrink-0">
                                <div className="hidden md:block">
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Leeladevi Parasmal Sancheti Kanya Mahavidyalaya</p>
                                </div>
                                <button
                                    onClick={() => setSelectedLab(null)}
                            ...
                            <div className="flex-1">
                                ...
                                <div className="space-y-4 text-gray-600 font-medium">
                                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 border-b border-gray-50 pb-4">
                                        ...
                                        <span className="text-oxford text-lg font-bold">Leeladevi Parasmal Sancheti Kanya Mahavidyalaya, Vidyawadi</span>
                                    </div>
                                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 border-b border-gray-50 pb-4">
