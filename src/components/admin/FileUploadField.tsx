...
import { FileText, X, Upload, Loader2, AlertCircle, FileCheck } from "lucide-react";
                ...
                <div className="w-32 h-32 rounded-2xl bg-gray-50 border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden relative group shrink-0 shadow-inner">
                    {value ? (
                        <div className="flex flex-col items-center gap-1 p-2">
                            ...
                            <span className="text-[8px] font-bold text-gray-400 text-center truncate w-24">
                                {getFileName(value)}
                            </span>
                        ...
                        <div className="text-gray-300 flex flex-col items-center gap-2">
                            <FileText size={24} />
                            <span className="text-[10px] font-bold uppercase tracking-tight">No File</span>
                        </div>
                    )}
