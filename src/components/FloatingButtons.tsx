...
export default function FloatingButtons() {
    const whatsappNumber = "+919414115115"; // Placeholder, update with actual number
    ...
    return (
        <>
            ...
            <motion.a
                ...
                className="fixed bottom-6 right-6 z-[90] bg-[#25D366] text-white p-4 rounded-full shadow-2xl transition-all hover:bg-[#20ba5a]"
